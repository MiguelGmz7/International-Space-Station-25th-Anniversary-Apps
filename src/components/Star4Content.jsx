...
import popup4 from '../assets/PopUps/4.jpg'
import julietaImg from '../assets/nave/Julieta.gif'

function Star4Content() {
  const messages = [
    'How do they exercise?',
    'Locations: Node 3',
    "Without gravity, bones don’t have to support our body weight, so they get weaker and lose density over time.",
    'Astronauts exercise two hours a day to keep their muscles and bones strong in zero gravity.'
  ]
