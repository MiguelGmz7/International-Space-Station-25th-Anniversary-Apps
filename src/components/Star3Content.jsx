...
import popup3 from '../assets/PopUps/3.jpg'
import julietaImg from '../assets/nave/Julieta.gif'

function Star3Content() {
  const messages = [
    'Where do they eat?',
    'Locations: Node 1 (Unity)',
    'Food is packaged to be safe in microgravity and easy to prepare.',
    'Astronauts often use tortillas instead of bread to avoid crumbs floating everywhere.'
  ]
